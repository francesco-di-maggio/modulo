...
,
																		"valueof" : 																		{
																			"parameter_enum" : [ "mo-abc", "mo-blocks", "mo-controller", "mo-nanoKONTROL2", "mo-one2many", "mo-recording", "mo-regression" ],
...
,
																		"valueof" : 																		{
																			"parameter_enum" : [ "mo-fm", "mo-granulator", "mo-live", "mo-sonification", "mo-theremini" ],
...
,
					"patching_rect" : [ 24.5, 335.021173999999974, 889.0, 413.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.5, 337.021173999999974, 783.0, 415.0 ],
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 141.0, 140.0, 40.0, 23.0 ],
									"text" : "sel 13"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 181.0, 32.0, 23.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 100.0, 83.0, 23.0 ],
									"text" : "modifiers 100"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 141.0, 100.0, 50.5, 23.0 ],
									"text" : "key"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 215.0, 35.0, 23.0 ],
									"text" : "clear"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 150.5, 126.0, 150.5, 126.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 150.5, 177.0, 72.5, 177.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
,
					"patching_rect" : [ 891.0, 145.0, 78.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"editing_bgcolor" : [ 0.694117647058824, 0.694117647058824, 0.694117647058824, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 891.0, 180.0, 49.0, 23.0 ],
					"text" : "console"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.5, 192.0, 775.5, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.158536583185196, 225.665829000000031, 762.341463416814804, 15.99633318471524 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.5, 158.0, 614.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.5, 193.665829000000031, 614.0, 35.0 ],
					"text" : "A multichannel, modular approach for quick prototyping.",
					"textjustification" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-7::obj-12::obj-8::obj-11" : [ "live.menu[3]", "live.menu", 0 ],
			"obj-7::obj-12::obj-8::obj-17" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-7::obj-12::obj-8::obj-21" : [ "live.menu[1]", "live.menu", 0 ],
