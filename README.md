...
Although the toolkit focuses on acquiring, processing and mapping input data to sound, the routing modules make it easy to connect users to their own workflow and sound synthesis tools.
