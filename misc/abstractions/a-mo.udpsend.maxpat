...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 87.666666666666657, 408.944444444444343, 91.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 38.973149760419801, -0.058990031480789, 169.0, 16.0 ],
					"rounded" : 0.0,
					"text" : "/output-16",
...
, 			{
		...
		"parameters" : 		{
			"obj-1" : [ "live.text[16]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
