{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 251.0, 452.5, 93.0, 35.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 3.0, 52.0, 44.96969282627106, 15.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1015.0, 70.0, 150.44264309008906, 5.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 97.25685462355614, 4.488777905702591, 40.50145781040192, 15.0 ],
                    "saved_attribute_attributes": {
                        "activebgcolor": {
                            "expression": ""
                        },
            ...
            },
            {
                "box": {
                    ...
                    "presentation": 1,
                    "presentation_rect": [ 3.0, 40.0, 44.96969282627106, 15.0 ],
                    "saved_attribute_attributes": {
                        "activebgcolor": {
                            "expression": ""
                        },
            ...
            },
            {
                "box": {
                    ...
                    "pictures": [ "unlock.svg", "lock.svg" ],
                    "presentation": 1,
                    "presentation_rect": [ 52.36907556653023, 4.488777905702591, 41.14713080227375, 14.962593019008636 ],
                    "remapsvgcolors": 1,
                    "saved_attribute_attributes": {
                        "activebgcolor": {
                            "expression": ""
        ...
        "parameters": {
            "obj-10": [ "live.text[204]", "live.text", 0 ],
            "obj-14": [ "live.text[202]", "live.text", 0 ],
            "obj-15": [ "live.numbox[180]", "live.numbox", 0 ],
            "obj-27": [ "live.numbox[181]", "live.numbox", 0 ],
            "obj-32": [ "live.numbox[179]", "live.text", 0 ],
            "obj-33": [ "live.text[203]", "live.text", 0 ],
            "obj-35": [ "live.numbox[176]", "live.numbox", 0 ],
            "obj-38": [ "live.numbox[178]", "live.text", 0 ],
            "obj-43": [ "live.numbox[177]", "live.numbox", 0 ],
            "parameterbanks": {
                "0": {
                    "index": 0,
                    "name": "",
