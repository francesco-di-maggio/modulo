...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.836120128631592, 41.471571683883667, 21.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.170568287372589, 41.471571683883667, 20.0, 18.0 ],
					"text" : "val",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 240.0, 21.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.086956381797791, 41.5, 19.0, 18.0 ],
					"text" : "cc",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 24.0, 27.0, 18.0 ],
					"text" : "port",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 40.5, 99.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 25.0, 19.0, 18.0 ],
					"text" : "ch",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 885.306426948308854, 190.809273335687408, 340.0, 23.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1 ],
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 43.0, 19.0103358139595, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 43.0, 20.485906173402896, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 114.0, 44.0, 96.0, 13.0 ],
					"proportion" : 0.5,
					"rounded" : 0,
					"saved_attribute_attributes" : 					{
						"bgfillcolor" : 						{
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-123::obj-35" : [ "live.text[664]", "live.text", 0 ],
			"obj-123::obj-53" : [ "live.text[828]", "live.text", 0 ],
			"obj-123::obj-66" : [ "live.numbox[100]", "live.numbox", 0 ],
			"obj-123::obj-68" : [ "live.numbox[99]", "live.numbox", 0 ],
			"obj-123::obj-72" : [ "live.numbox[162]", "live.numbox", 0 ],
			...
			"obj-5" : [ "live.text[476]", "live.text", 0 ],
			...
			"obj-53" : [ "live.text[477]", "live.text", 0 ],
			"obj-56" : [ "live.numbox[382]", "live.numbox", 0 ],
			"obj-72" : [ "live.numbox[482]", "live.numbox", 0 ],
