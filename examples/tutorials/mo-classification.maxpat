...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.5, 257.486411435185119, 90.0, 68.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.0, 259.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.5, 358.486411435185119, 90.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.0, 360.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.5, 325.486411435185119, 104.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 245.0, 327.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.5, 617.486411435185119, 104.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.0, 619.986411435185119, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			"obj-18::obj-38" : [ "live.text[20]", "live.text", 0 ],
			"obj-18::obj-4" : [ "live.text[19]", "live.text", 0 ],
			"obj-18::obj-56" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-18::obj-59" : [ "live.text[21]", "live.text", 0 ],
