...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.5, 118.486411435185119, 112.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 289.0, 127.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.5, 395.486411435185119, 124.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 272.5, 358.486411435185119, 124.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 289.0, 397.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 244.0, 360.986411435185062, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.5, 363.486411435185119, 108.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 272.5, 325.486411435185119, 108.0, 25.0 ],
					"text" : "record example"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 289.0, 365.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 244.0, 327.986411435185062, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.0, 88.486411435185005, 73.0, 25.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 289.0, 90.986411435185062, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-18::obj-107::obj-28" : [ "live.text[12]", "live.text", 0 ],
			...
			"obj-18::obj-1::obj-28" : [ "live.text[13]", "live.text", 0 ],
			...
			"obj-18::obj-36::obj-28" : [ "live.text[19]", "live.text", 0 ],
			...
			"obj-18::obj-74::obj-28" : [ "live.text[7]", "live.text", 0 ],
