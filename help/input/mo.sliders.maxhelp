...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 528.945414036184388, 255.0, 115.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.945414036184388, 214.0, 95.0, 25.0 ],
					"text" : "mute output "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.945414036184388, 214.0, 121.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 248.0, 215.0, 50.0, 23.0 ],
					"varname" : "number[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.666666666666629, 255.0, 53.0, 23.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 437.666666666666742, 214.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.666666666666629, 296.0, 67.0, 23.0 ],
					"text" : "polarity $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 500.666666666666629, 255.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.945414036184502, 296.0, 33.0, 23.0 ],
					"text" : "rand"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 351.0, 226.0, 135.0 ],
					"varname" : "mo.sliders",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 447.166666666666629, 336.0, 257.5, 336.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 447.166666666666742, 240.0, 447.166666666666629, 240.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 1 ],
					"midpoints" : [ 605.445414036184502, 336.0, 257.5, 336.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 510.166666666666629, 282.0, 510.166666666666629, 282.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 1 ],
					"midpoints" : [ 510.166666666666629, 336.0, 257.5, 336.0 ],
					"source" : [ "obj-9", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-13::obj-107::obj-8" : [ "live.text[6]", "live.text", 0 ],
			...
			"obj-13::obj-1::obj-8" : [ "live.text[3]", "live.text", 0 ],
			...
			"obj-13::obj-36::obj-8" : [ "live.text[9]", "live.text", 0 ],
			...
			"obj-13::obj-40::obj-8" : [ "live.text[12]", "live.text", 0 ],
			...
			"obj-13::obj-41::obj-8" : [ "live.text[10]", "live.text", 0 ],
			...
			"obj-13::obj-42::obj-8" : [ "live.text[15]", "live.text", 0 ],
			...
			"obj-13::obj-43::obj-8" : [ "live.text[13]", "live.text", 0 ],
			...
			"obj-13::obj-44::obj-8" : [ "live.text[19]", "live.text", 0 ],
			...
			"obj-13::obj-45::obj-8" : [ "live.text[17]", "live.text", 0 ],
			...
			"obj-13::obj-46::obj-8" : [ "live.text[22]", "live.text", 0 ],
			...
			"obj-13::obj-47::obj-8" : [ "live.text[24]", "live.text", 0 ],
			...
			"obj-13::obj-48::obj-8" : [ "live.text[26]", "live.text", 0 ],
			...
			"obj-13::obj-49::obj-8" : [ "live.text[28]", "live.text", 0 ],
			...
			"obj-13::obj-50::obj-8" : [ "live.text[33]", "live.text", 0 ],
