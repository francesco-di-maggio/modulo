...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.005791574060538, 689.0, 68.0, 21.0 ],
					"text" : "step values"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.005791574060538, 263.0, 31.0, 23.0 ],
					"text" : "zero"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 157.505791574060538, 432.0, 50.5, 432.0 ],
					"source" : [ "obj-7", 0 ]
				}
