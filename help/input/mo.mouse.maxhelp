    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 225.70731711387634, 323.0, 189.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 186.70731711387634, 277.0, 240.0, 39.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 181.70731711387634, 205.5, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "text": "1",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 211.70731711387634, 181.5, 203.0, 68.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 181.70731711387634, 324.0, 36.0, 23.0 ],
                    "text": "reset"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 76.28023754060268, 164.0, 92.0, 25.0 ],
                    "text": "mute output"
                }
            },
            {
                "box": {
                    ...
                    "text": "Keep track of mouse's movements and clicks.",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 9.0, 83.0, 134.0, 23.0 ],
                    "text": "Report mouse state."
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 9.0, 9.0, 253.0, 71.0 ],
                    "text": "mo.mouse"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 41.0, 204.0, 53.0, 23.0 ],
                    "text": "mute $1"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-4", 0 ],
                    "midpoints": [ 191.20731711387634, 360.0, 50.5, 360.0 ],
                    "source": [ "obj-9", 0 ]
                }
            }
        ],
        "parameters": {
            "obj-4::obj-45": [ "live.text[786]", "live.text", 0 ],
            "obj-4::obj-53": [ "live.text[787]", "live.text", 0 ],
            "obj-4::obj-9": [ "live.text[785]", "live.text", 0 ],
            "parameterbanks": {
                "0": {
                    "index": 0,
                    "name": "",
