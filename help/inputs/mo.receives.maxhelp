...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 506.0, 93.245352983474845, 74.0, 25.0 ],
					"text" : "set name"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 479.0, 95.745352983474845, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.255791574060595, 94.245352983474845, 35.0, 23.0 ],
					"text" : "\" \"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 94.245352983474845, 67.0, 23.0 ],
					"text" : "my-receive",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 446.755791574060595, 132.0, 369.5, 132.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12::obj-153" : [ "live.text[71]", "live.text", 0 ],
