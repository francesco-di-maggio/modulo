...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.94541403618436, 166.0, 53.0, 25.0 ],
					"text" : "click "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 102.0, 290.0, 22.0 ],
					"text" : "Set the condition for either of the three triggers.",
...
, 			{
				"box" : 				{
					...
					"text" : "Output a trigger based on right value."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 163.89082807236872, 339.702987670898438, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 102.94541403618436, 339.702987670898438, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 41.0, 339.702987670898438, 24.0, 24.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 173.5, 309.0, 173.39082807236872, 309.0 ],
					"source" : [ "obj-17", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 112.0, 309.0, 112.44541403618436, 309.0 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 50.5, 309.0, 50.5, 309.0 ],
					"source" : [ "obj-17", 0 ]
				}
