...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 526.0, 209.762840316425326, 232.196993619203568 ],
					"varname" : "mo.scope",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 308.730655144900084, 209.762840316425326, 203.750918656587601 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 220.856800861656666, 99.173431724309921, 74.355428084731102 ],
					"varname" : "mo.rms~",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 170.862318638712168, 99.173431724309921, 36.476056024432182 ],
					"varname" : "mo.list2~",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 33.5, 501.0, 33.5, 501.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-66" : [ "live.numbox[71]", "live.numbox", 0 ],
			"obj-4::obj-68" : [ "live.numbox[64]", "live.numbox", 0 ],
			...
			"obj-9::obj-11" : [ "live.text[53]", "live.text", 0 ],
