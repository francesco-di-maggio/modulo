...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 92.480686187744141, 68.0, 25.0 ],
					"text" : "set time"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 164.0, 94.980686187744141, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 107.836733102798462, 93.480686187744141, 50.0, 23.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 37.283437728881836, 87.0, 37.283437728881836, 87.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-2::obj-15" : [ "live.text[32]", "live.text", 0 ],
			"obj-2::obj-8" : [ "live.text[188]", "live.text", 0 ],
