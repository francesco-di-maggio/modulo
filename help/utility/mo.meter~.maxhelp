        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 291.6406159090907, 544.5, 45.0, 45.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 377.8553613636359, 554.0, 74.0, 25.0 ],
                    "text": "start dsp"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 349.1406159090907, 557.0, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "text": "1",
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "multichannelsignal" ],
                    "patching_rect": [ 41.0, 299.04793100000006, 214.0, 214.0 ],
                    "varname": "mo.meter~",
                    "viewvisibility": 1
                }
            }
