...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 396.890492372269819, 505.0, 32.0, 21.0 ],
									"text" : "stop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 376.890492372269819, 528.0, 52.0, 37.0 ],
									"text" : ";\rtoggle 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 215.175746917724609, 167.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 294.890492372269819, 541.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 294.890492372269819, 489.0, 72.0, 23.0 ],
									"text" : "metro 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 239.890492372269819, 165.0, 162.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 294.890492372269819, 359.0, 134.0, 39.0 ],
									"text" : "type: \";toggle 1\", \nand hit \"Return\" key"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 294.890492372269819, 456.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 294.890492372269819, 425.0, 84.0, 23.0 ],
									"text" : "receive toggle"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 304.390492372269819, 450.0, 304.390492372269819, 450.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 304.390492372269819, 513.0, 304.390492372269819, 513.0 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 304.390492372269819, 483.0, 304.390492372269819, 483.0 ],
									"source" : [ "obj-22", 0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 63.529780500000015, 197.0, 58.0, 23.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 309.529780500000015, 238.5, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 335.529780500000015, 236.0, 76.0, 25.0 ],
									"text" : "set scene"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 254.529780500000015, 237.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 254.529780500000015, 195.5, 112.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 214.0, 197.0, 36.0, 23.0 ],
									"text" : "write"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 225.029780500000015, 163.5, 97.0, 25.0 ],
									"text" : "load .json file"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 185.5, 165.0, 33.0, 23.0 ],
									"text" : "read"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 223.5, 285.0, 50.5, 285.0 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 264.029780500000015, 285.0, 50.5, 285.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 195.0, 285.0, 50.5, 285.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
		...
		"parameters" : 		{
			...
			"obj-3::obj-5::obj-30" : [ "live.text[5]", "live.text", 0 ],
			"obj-3::obj-5::obj-37" : [ "live.text[1]", "live.text", 0 ],
			"obj-3::obj-5::obj-41" : [ "live.text[53]", "live.text", 0 ],
			"obj-3::obj-5::obj-5" : [ "live.text[326]", "live.text", 0 ],
			"obj-3::obj-5::obj-85" : [ "live.text[4]", "live.text", 0 ],
			...
			"obj-4::obj-5::obj-30" : [ "live.text[28]", "live.text", 0 ],
			"obj-4::obj-5::obj-37" : [ "live.text[7]", "live.text", 0 ],
			"obj-4::obj-5::obj-41" : [ "live.text[3]", "live.text", 0 ],
			"obj-4::obj-5::obj-5" : [ "live.text[6]", "live.text", 0 ],
			"obj-4::obj-5::obj-85" : [ "live.text[27]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
