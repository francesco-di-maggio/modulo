{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 64.0, 299.4999999999999, 187.0, 54.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 396.0, 316.4999999999999, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "text": "3",
                    "textcolor": [ 0.34902, 0.34902, 0.34902, 1.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 421.0, 314.9999999999999, 61.0, 25.0 ],
                    "text": "launch"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 353.0, 314.9999999999999, 35.0, 22.0 ],
                    "text": "open"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 41.0, 378.5, 214.0, 45.0 ],
                    "varname": "mo.launch",
                    "viewvisibility": 1
                }
            },
        ...
        "parameters": {
            ...
            "obj-3::obj-42": [ "live.text[894]", "live.text", 0 ],
            "parameterbanks": {
                "0": {
                    "index": 0,
                    "name": "",
