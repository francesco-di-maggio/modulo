...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 296.790213162079453, 242.0, 50.0 ],
					"text" : "NOTE: The module is connected to a mx.ezadc~ object, which allows to set local mode on/off inside the main patcher."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 165.0, 208.0, 25.0 ],
					"text" : "turn on/off local audio processing "
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 177.0, 165.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 216.0, 50.0, 23.0 ],
					"text" : "local $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 83.0, 336.0, 23.0 ],
					"text" : "Audio on/off button, and multichannel output signal."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 186.5, 192.0, 186.5, 192.0 ],
					"source" : [ "obj-10", 0 ]
				}
