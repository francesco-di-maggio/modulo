        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 125.0, 165.5, 100.0, 25.0 ],
                    "text": "generate data"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 235.5, 360.5, 50.0, 23.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 235.5, 318.4999999999999, 44.0, 23.0 ],
                    "text": "r value"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 123.0, 201.6245406717062, 92.0, 25.0 ],
                    "text": "mute output"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 92.0, 201.6245406717062, 24.0, 24.0 ],
                    "varname": "toggle[2]"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 92.0, 240.0, 53.0, 23.0 ],
                    "text": "mute $1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 284.7557915740606, 202.8754593282938, 29.5, 23.0 ],
                    "text": "\" \""
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 235.5, 254.5, 72.0, 23.0 ],
                    "text": "prepend set"
                }
            },
            {
        ...
        "lines": [
            {
                "patchline": {
                    ...
                    "midpoints": [ 245.0, 228.0, 245.0, 228.0 ],
                    "source": [ "obj-10", 0 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 245.0, 303.0, 101.5, 303.0 ],
                    "source": [ "obj-11", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-11", 0 ],
                    "midpoints": [ 294.2557915740606, 240.0, 245.0, 240.0 ],
                    "source": [ "obj-27", 0 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 245.0, 342.0, 245.0, 342.0 ],
                    "source": [ "obj-4", 0 ]
                }
            }
        ],
