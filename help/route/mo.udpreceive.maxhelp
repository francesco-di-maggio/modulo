{
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 236.0, 395.36989365518093, 119.0, 23.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 41.0, 395.36989365518093, 110.0, 23.0 ]
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 41.0, 315.869894, 214.0, 45.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 100.0, 165.5, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "text": "1",
            ...
            },
            {
                "box": {
                    ...
                    "text": "Receive messages over the network."
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 140.0, 263.5, 53.0, 23.0 ],
                    "text": "mute $1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 41.0, 216.1245406717062, 79.0, 23.0 ],
                    "text": "prepend port"
                }
            }
        ],
        "lines": [
            {
                "patchline": {
                    "destination": [ "obj-9", 0 ],
                    "midpoints": [ 149.5, 300.0, 50.5, 300.0 ],
                    "source": [ "obj-12", 0 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 149.5, 243.0, 149.5, 243.0 ],
                    "source": [ "obj-15", 0 ]
                }
            },
            {
        ...
        "parameters": {
            "obj-9::obj-115": [ "live.text[908]", "live.text", 0 ],
