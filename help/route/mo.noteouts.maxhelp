        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 356.70731711387634, 508.5, 126.0, 21.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 501.0, 312.0, 92.0, 25.0 ],
                    "text": "mute output"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 448.70731711387634, 262.5, 114.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 188.0, 165.5, 102.0, 25.0 ],
                    "text": "play/stop note"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 438.70731711387634, 213.5, 135.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 411.70731711387634, 216.0, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "text": "1",
                    "textcolor": [ 0.34902, 0.34902, 0.34902, 1.0 ]
                }
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 235.99999999999994, 263.5, 79.0, 23.0 ],
                    "text": "prepend port"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 41.0, 404.5, 214.0, 129.0 ],
                    "varname": "mo.noteouts",
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 471.0, 313.0, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 471.0, 358.0, 53.0, 23.0 ],
                    "text": "mute $1"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 391.70731711387634, 263.5, 50.0, 23.0 ]
                }
            },
            {
                "box": {
        ...
        "lines": [
            {
                "patchline": {
                    "destination": [ "obj-6", 0 ],
                    "midpoints": [ 480.5, 339.5, 480.5, 339.5 ],
                    "source": [ "obj-12", 0 ]
                }
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 401.20731711387634, 288.0, 401.49536840650444, 288.0 ],
                    "source": [ "obj-13", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 309.5, 249.0, 245.49999999999994, 249.0 ],
                    "source": [ "obj-40", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-42", 0 ],
                    "midpoints": [ 245.5, 240.0, 245.49999999999994, 240.0 ],
                    "source": [ "obj-41", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-43", 1 ],
                    "midpoints": [ 245.49999999999994, 288.0, 245.5, 288.0 ],
                    "source": [ "obj-42", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-43", 1 ],
                    "midpoints": [ 480.5, 390.0, 245.5, 390.0 ],
                    "source": [ "obj-6", 0 ]
                }
            },
            {
