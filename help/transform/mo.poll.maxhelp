    ...
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 92.2557915740606, 211.0, 50.0, 23.0 ],
                    "varname": "number"
                }
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "" ],
                    "patching_rect": [ 41.0, 258.451567, 70.0, 62.0 ],
                    "varname": "mo.line",
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 41.0, 337.9999999999999, 172.0, 23.0 ],
                    "presentation": 1,
                    "presentation_rect": [ 21.00000000000003, 314.9999999999999, 172.0, 23.0 ],
                    "setminmax": [ 0.0, 1.0 ],
                    "setstyle": 1,
                    "spacing": 2,
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-5", 1 ],
                    "midpoints": [ 101.7557915740606, 237.0, 101.5, 237.0 ],
                    "source": [ "obj-4", 0 ]
                }
            },
            {
