        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 244.22270331913876, 346.5, 74.0, 25.0 ],
                    "text": "start dsp"
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 28.0, 109.1, 40.0, 23.0 ],
                                    "text": "uzi 4"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 28.0, 190.2, 62.0, 23.0 ],
                                    "text": "zl.group 4"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 28.0, 149.64999999999998, 176.0, 23.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "bang" ],
                                    "patching_rect": [ 28.0, 68.55, 57.0, 23.0 ],
                                    "text": "metro 20"
                                }
                            },
                            {
