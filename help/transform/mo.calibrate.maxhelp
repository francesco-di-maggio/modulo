        ...
        "boxes": [
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 41.140616, 583.0, 172.0, 61.0 ],
                    "setminmax": [ 0.0, 1.0 ],
                    "setstyle": 3,
                    "spacing": 2
                }
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 552.5, 370.0, 126.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 488.5, 328.0, 126.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 291.5, 207.0, 117.0, 25.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 248.0, 164.5, 90.0, 25.0 ],
                    "text": "input values"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "offset": [ 0.0, 0.0 ],
                    "outlettype": [ "" ],
                    "patching_rect": [ 41.140616, 465.666667, 214.0, 84.0 ],
        ...
        "lines": [
            {
                "patchline": {
                    ...
                    "midpoints": [ 50.640616, 555.0, 50.640616, 555.0 ],
                    "source": [ "obj-1", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-1", 1 ],
                    "midpoints": [ 374.0, 450.0, 245.640616, 450.0 ],
                    "source": [ "obj-10", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-1", 1 ],
                    "midpoints": [ 245.5, 234.0, 245.640616, 234.0 ],
                    "source": [ "obj-15", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-1", 1 ],
                    "midpoints": [ 442.0, 450.0, 245.640616, 450.0 ],
                    "source": [ "obj-5", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-1", 1 ],
                    "midpoints": [ 507.0, 450.0, 245.640616, 450.0 ],
                    "source": [ "obj-6", 0 ]
                }
            },
            {
                "patchline": {
                    "destination": [ "obj-1", 1 ],
                    "midpoints": [ 300.0, 450.0, 245.640616, 450.0 ],
                    "source": [ "obj-8", 0 ]
                }
            }
        ],
