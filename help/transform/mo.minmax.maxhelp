...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 474.0, 102.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 435.0, 60.0, 21.0 ],
					"text" : "min - max"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 41.140616000000001, 473.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 83.0, 210.0, 23.0 ],
					"text" : "Hard calibration of a list of data."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 41.140616000000001, 340.666666666666629, 70.0, 57.5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 434.0, 118.0, 23.0 ],
					"text" : "-24.6 23.8"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 101.640615999999994, 420.0, 205.5, 420.0 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 50.5, 267.0, 50.640616000000001, 267.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-21::obj-37" : [ "live.text[26]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
